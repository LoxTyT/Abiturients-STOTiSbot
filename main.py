...
def help(message):
    ...
    # Отправляем сообщение с помощью бота и клавиатурой
...
def faq(message):
    ...
    # Отправляем сообщение с помощью бота и клавиатурой
    bot.send_message(message.chat.id, faq_text, parse_mode="HTML", reply_markup=markup)
...
def contacts(message):
    ...
    # Отправляем сообщение с помощью бота и клавиатурой
    bot.send_message(message.chat.id, contacts_text, parse_mode="HTML", reply_markup=markup)
